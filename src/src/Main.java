...
public class Main {
    public static void main(String[] args) throws Exception{
        ...
        while(menu<1 || menu>3){
            ...
            System.out.println("Select the option (between 1 and 3): ");
            menu = sc1.nextInt();
        }
        System.out.println();
        ...
        switch (menu){
            case 1 :
                ...
                while (solutions.get(0).getFitnescore() != 0 && count < 100) {
                ...
                if (count == 100 && solutions.get(0).getFitnescore() != 0) {
            ...
            case 2 :
                ...
                //Genetic algorithm with the use of both Crossover and Mutation methods
                while (solutions2.get(0).getFitnescore() != 0 && count2 < 100) {
                ...
                if (count2 == 100 && solutions2.get(0).getFitnescore() != 0) {
